...
description: 用于在本仓库生成或修改后台原型效果图，尤其是 docs/06-原型效果图/后台管理 下的 HTML 页面，并要求优先复用已有公共组件。适用于“生成原型效果图”“新建原型页”“调整原型页面”“补一个页面状态”“统一原型样式”“组件化原型”“替换为公共组件”等场景。
---
...
如果目标页面不在 `docs/06-原型效果图/后台管理/` 下，只有当该页面也明确沿用这套原型体系时，才使用本技能。
